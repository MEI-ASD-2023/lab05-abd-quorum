...
\newunicodechar{π}{\ifmmode\ensuremath{\pi}\xspace\else\textpi\fi}
\usepackage{textcomp}
\usepackage{scalerel}
\def\🔒{\scalerel*{\includegraphics[scale=0.15]{images/lock.eps}}{\textrm{\textbigcircle}}}
...
\subtitle{\textsc{\textbf{Algoritmos e Sistemas Distribuídos (ASD)}}}
...
\begin{frame}{Remember}
  ...
  \begin{itemize}\wideitems
    \item Test 1 on Friday October 27th 2023
    \item Project Phase 2 starts next week
  \end{itemize}
\end{frame}

\begin{frame}{Lab for today}
  \vspace{1cm}
  \begin{itemize}
    \wideitems
    \item Use your source code in Phase 1 of the project to implement a \hlgreen{read/write} register, on top of an \hlyellow{ABD Quorum} design.
    \item More details at \url{https://github.com/MEI-ASD-2023/lab05-abd-quorum}
    \item Will be useful for Phase 2 of the project
  \end{itemize}
\end{frame}



\section{ABD Quorum Register}
...
\begin{frame}{Read/Write Variable Replication}
  ...
  \begin{itemize}
    ...
    \item Writes and reads can happen \emph{concurrently}
  \end{itemize}
\end{frame}
...
\begin{frame}{Read algorithm: naïve attempt}
  \vspace{1cm}
  \begin{enumerate}
    \wideitems
...
\begin{frame}{ABD Read algorithm}
  \vspace{1cm}
  \textbf{Solution}: add a \hlcyan{\writebackf{}} phase\bigskip
  \begin{enumerate}
    \narrowitems
    \item \textbf{Phase 1}: Proceed as in naïve case
